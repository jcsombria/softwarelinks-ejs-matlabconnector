 ...
 */
package es.uned.dia.jcsombria.softwarelinks.elements;
...
public class MatlabJsonRpcElement extends AbstractModelElement { 
	...
	private static final String XML_NODE_LABEL_JIL = "rpcmatlab";
	...
	private JTextField viFileText = new JTextField("", 32);
	...
	public String getConstructorName() {
		return "es.uned.dia.jcsombria.softwarelinks.matlab.client.RemoteMatlabConnectorClient";
	}
	...
	protected String getHtmlPage() {
		return "es/uned/jchacon/model_elements/softwarelinks/Matlab.html";
	}
