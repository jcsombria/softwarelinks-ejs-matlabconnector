 ...
 *
 */
public class SimulinkExampleFixedUpdate {
  // Declare local variables
  public double time=0, frequency=1, value=0;     

  public static void main (String[] args) {
    new SimulinkExampleFixedUpdate();
  }

  public SimulinkExampleFixedUpdate() {
    //Createa a Simulink connection
    SimulinkExternalApp externalApp=new SimulinkExternalApp("fsmk.mdl",0.1);
