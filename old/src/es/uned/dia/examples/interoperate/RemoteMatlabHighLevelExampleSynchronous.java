 ...
 *
 */
public class RemoteMatlabHighLevelExampleSynchronous {
  // Declare local variables
  public double time=0, frequency=1, value=0;     

  public static void main (String[] args) {
    new RemoteMatlabHighLevelExampleSynchronous();
  }

  public RemoteMatlabHighLevelExampleSynchronous() {
    // Create the external application
    ExternalApp externalApp = new RMatlabExternalApp("<matlab:62.204.199.122:2005>");
