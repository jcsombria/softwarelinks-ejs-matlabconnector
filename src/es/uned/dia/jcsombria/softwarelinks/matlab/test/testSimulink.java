...
import es.uned.dia.jcsombria.softwarelinks.matlab.client.RemoteSimulinkConnector;
import es.uned.dia.jcsombria.softwarelinks.matlab.client.SimulinkConnector;
...
//	@Test
	public void testRemoteSimulinkConnectorClient() {		
		...
		RemoteSimulinkConnector simulink = new RemoteSimulinkConnector(rmcc);
		simulink.setModel("./bounce.mdl");
		simulink.setContext(this);
		simulink.linkVariables("position", "bounce/Position", "out", "1");
	    simulink.linkVariables("velocity", "bounce/Velocity", "out", "1");
